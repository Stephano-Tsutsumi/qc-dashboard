insert into public.issues (id, priority, title, description) values
  ('p0-fictional-transcript', 'p0',
...
insert into public.issue_states (issue_id, status)
select id, 'open' from public.issues
